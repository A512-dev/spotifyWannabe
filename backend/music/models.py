...
class Album(TimestampedModel):
    ...
    cover_image = models.ImageField(upload_to=album_cover_upload_to, null=True, blank=True, max_length=500)
...
class Track(TimestampedModel):
    ...
    title = models.CharField(max_length=180)
    audio_file = models.FileField(upload_to=track_audio_upload_to, max_length=500)
    cover_image = models.ImageField(upload_to=track_cover_upload_to, null=True, blank=True , max_length=500)
