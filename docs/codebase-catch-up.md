...
13. **Some frontend source text is mojibake.** Persian translations/comments and a few separators/arrows show encoding corruption in source. RTL switching exists, but localization coverage is only a small dictionary and most page copy remains English.
